package mx.freshmanasoft.phs.controller.storage;
...
import mx.freshmanasoft.phs.service.storage.StorageService;
...
public class FileUploadController {
	...
	public Object handleFileUpload(@RequestParam("file") MultipartFile file) {
		...
		resp.put("newFileName", newFileName);
		resp.put("message", "FILE_UPLODED");
